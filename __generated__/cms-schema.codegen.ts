...
/** Block of type Persona Fact (persona_fact) */
export type PersonaFactRecord = RecordInterface & {
  __typename?: 'PersonaFactRecord';
  _createdAt: Scalars['DateTime'];
...
/** Block of type Persona Fact (persona_fact) */
export type PersonaFactRecord_SeoMetaTagsArgs = {
  locale: InputMaybe<SiteLocale>;
};

export type PersonaModelFilter = {
  OR: InputMaybe<Array<InputMaybe<PersonaModelFilter>>>;
...
export type PersonaModelIntroField = {
  __typename?: 'PersonaModelIntroField';
  blocks: Array<Scalars['String']>;
  links: Array<Scalars['String']>;
  value: Scalars['JsonField'];
};

export enum PersonaModelOrderBy {
...
/** Record of type Persona (persona) */
export type PersonaRecord = RecordInterface & {
  __typename?: 'PersonaRecord';
  _createdAt: Scalars['DateTime'];
  _firstPublishedAt: Maybe<Scalars['DateTime']>;
  _isValid: Scalars['BooleanType'];
  _modelApiKey: Scalars['String'];
  ...
  createdAt: Scalars['DateTime'];
  facts: Array<PersonaFactRecord>;
  id: Scalars['ItemId'];
  intro: PersonaModelIntroField;
...
/** Record of type Persona (persona) */
export type PersonaRecord_SeoMetaTagsArgs = {
  locale: InputMaybe<SiteLocale>;
};
...
export type Query = {
  ...
  _allPersonasMeta: CollectionMetadata;
  /** Returns meta information regarding a record collection */
  ...
  allPersonas: Array<PersonaRecord>;
  /** Returns a collection of records */
  allTests: Array<TestRecord>;
  /** Returns a collection of assets */
  allUploads: Array<FileField>;
  /** Returns a specific record */
  persona: Maybe<PersonaRecord>;
  /** Returns a specific record */
...
export type Query_AllPersonasMetaArgs = {
  fallbackLocales: InputMaybe<Array<SiteLocale>>;
  filter: InputMaybe<PersonaModelFilter>;
  locale: InputMaybe<SiteLocale>;
};
...
export type QueryAllPersonasArgs = {
  ...
  locale: InputMaybe<SiteLocale>;
  orderBy?: InputMaybe<Array<InputMaybe<PersonaModelOrderBy>>>;
...
export type ResponsiveImageFragmentFragment = { __typename: 'ResponsiveImage', aspectRatio: any, alt: string | null, base64: string | null, height: any, sizes: string, src: string, srcSet: string, title: string | null, webpSrcSet: string, width: any };

export type GetThumbnailsQueryVariables = Exact<{
  thumbnailImgix: ImgixParams;
}>;


export type GetThumbnailsQuery = { __typename?: 'Query', allUploads: Array<{ __typename?: 'FileField', responsiveImage: { __typename: 'ResponsiveImage', aspectRatio: any, alt: string | null, base64: string | null, height: any, sizes: string, src: string, srcSet: string, title: string | null, webpSrcSet: string, width: any } | null }> };
...
export const ResponsiveImageFragmentFragmentDoc = gql`
  ...
  width
    ...
    `;
export const GetThumbnailsDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getThumbnails(variables: GetThumbnailsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetThumbnailsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetThumbnailsQuery>(GetThumbnailsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getThumbnails', 'query');
    }
  };
}
